...
* :mod:`ogywatch.proceedings` — per-sitting plenary proceedings: the speech
...
* :mod:`ogywatch.representatives` — the representative registry: bio, faction
...
(:mod:`ogywatch.felicitas`); the legacy CGI/PAIR backends are documented in the
