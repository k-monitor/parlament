...
export default {
  ...
  profile: {
    ...
    activity: 'Activity', activityCaption: 'Daily activity — speeches and submitted documents',
    ...
    activityDay: 'Day', activityDocs: 'documents', activityLess: 'less', activityMore: 'more',
