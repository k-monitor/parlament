...
export default {
  ...
  interjections: {
    ...
    clickHint: 'Click an arrow to read the interjections behind it, or a member for the ones that are theirs — the arrow in the panel turns the direction round.',
    ...
    anyone: 'Anyone',
    pickFrom: 'Choose who interjected',
    pickTo: 'Choose who was interrupted',
    reverse: 'Reverse the direction',
    reverseNone: 'Nothing was ever shouted the other way',
    rowSpeaker: 'Heckler:',
    rowTarget: 'Interrupted:',
    close: 'Close',
    watch: 'Watch',
    zoomIn: 'Zoom in',
    zoomOut: 'Zoom out',
  ...
  about: {
    ...
    sourcesCrow: '<a href="https://www.linkedin.com/in/zoltanvarju/" target="_blank" rel="noopener">Zoltán Varjú</a> (<a href="https://crowintelligence.org/" target="_blank" rel="noopener">crow intelligence</a>) has been a great help in the development. Among other things, we owe him the <a href="https://saphes.readthedocs.io" target="_blank" rel="noopener">saphes</a> text-metrics library, an <a href="https://crowintelligence.org/parlamonitor-dashboard/" target="_blank" rel="noopener">experimental dashboard</a>, advice on NLP and more general development ideas.',
    ...
    sourcesParlaCap: 'To categorise speeches and documents we used the <a href="https://huggingface.co/classla/ParlaCAP-Topic-Classifier" target="_blank" rel="noopener">ParlaCap</a> model, created by Taja Kuzman Pungeršek, Peter Rupnik, Daniela Širinić, Nikola Ljubešić.',
  ...
  // The coming sitting's order paper (NR-5). A plan, not a record — see the
  ...
  upcoming: {
    ...
    empty: 'No sitting agenda has been announced.',
    startsAt: 'Sitting starts',
    decisionsFrom: 'Decisions no earlier than',
    endsAt: 'Expected end',
    showAll: '{n} more agenda items',
    showLess: 'Show less',
    noItems: 'The agenda\'s details could not be read — the document itself opens above.',
    houseCommittee: "The House Committee's next meeting",
    documents: 'Further documents',
    flags: {
      two_thirds: 'two-thirds majority',
      four_fifths: 'four-fifths majority',
      cardinal: 'cardinal law',
      exceptional: 'exceptional procedure',
      urgent: 'urgent debate',
      derogation: 'standing-orders derogation',
      nationality: 'nationality item',
      eu: 'EU item',
      quorum: 'quorum required',
      secret_vote: 'secret ballot',
    },
  },
  agendaTypes: {
