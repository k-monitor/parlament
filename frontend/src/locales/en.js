...
export default {
  ...
  about: {
    ...
    body4: 'The current version of the site (published in July 2026) is the result of a first, experimental phase; over the coming months we will extend it based on user feedback and with further features envisaged by K-Monitor. Feedback about the site is <a href="mailto:info&#64;k-monitor.hu?subject=Parlamonitor%20feedback">welcome by e-mail</a>.',
